  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Quick Task - Login', style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(224, 241, 255, 1))),
        backgroundColor: Color.fromARGB(255, 248, 72, 72),
        centerTitle: true),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
              ...
              Center(
                child: const Text('Student ID: 2021MT70503',
                    style:
                        TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 42, 42, 42))),
              ),
              SizedBox(
